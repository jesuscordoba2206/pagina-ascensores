...
export const metadata = buildPageMetadata({
  title: 'Empresa de Transporte Vertical en Colombia | Portafolio Elevators ITV',
  description:
    'Conoce el portafolio de instalaciones de ascensores y escaleras electricas de Elevators ITV en Colombia. Proyectos, experiencia tecnica y soluciones integrales para edificios.',
  path: '/empresa',
  keywords: [
    'empresa de transporte vertical en Colombia',
    'portafolio de ascensores',
    'instalaciones de escaleras electricas',
    'proyectos de ascensores comerciales',
  ],
});
...
export default async function EmpresaPage() {
  ...
  return (
    <>
      <JsonLd id="breadcrumbs-empresa-jsonld" data={breadcrumbJsonLd} />
          ...
          <section className="px-6 pb-12">
            <div className="mx-auto max-w-7xl">
              <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tight max-w-4xl">
                Portafolio de instalaciones de transporte vertical de alto impacto en Colombia.
              </h1>
                    ...
                    >
                      <div className="relative h-44 md:h-56 w-full overflow-hidden">
                        <Image
                          ...
                          alt={`${proyecto.title} - instalacion de transporte vertical en Colombia`}
                          fill
